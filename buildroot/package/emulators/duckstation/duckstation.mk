...
DUCKSTATION_CONF_OPTS += -DBUILD_QT_FRONTEND=OFF -DBUILD_SDL_FRONTEND=OFF -DBUILD_NOGUI_FRONTEND=ON -DUSE_DRMKMS=OFF -DUSE_WAYLAND=OFF -DUSE_X11=OFF
DUCKSTATION_CONF_OPTS += -DCMAKE_C_FLAGS="-DEGL_NO_X11"
DUCKSTATION_DEPENDENCIES += sdl2 libevdev
