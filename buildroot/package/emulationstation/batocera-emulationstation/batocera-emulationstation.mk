...
BATOCERA_EMULATIONSTATION_CONF_OPTS += -DEGL=ON -DFBDEV=ON
...
# # on odroidga: set resolution and EGL/GL hack
	...
	BATOCERA_EMULATIONSTATION_PREFIX += SDL_VIDEO_GL_DRIVER=/lib/libGLESv2.so SDL_VIDEO_EGL_DRIVER=/lib/libGLESv2.so
#endif
